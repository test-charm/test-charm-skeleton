...
public class Browser {
    ...
    public void launchByUrl(String path) {
        getWebDriver().get("http://host.docker.internal:10082" + path);
    }
    ...
    public void shouldNotHaveText(String text) {
        await().ignoreExceptions().untilAsserted(() -> assertThat(getWebDriver().findElements(xpath("//*[text()='" + text + "']"))).isEmpty());
    }
    ...
    private WebDriver createWebDriver() {
        return new RemoteWebDriver(new URL("http://web-driver.tool.net:14444"), DesiredCapabilities.chrome());
    }
